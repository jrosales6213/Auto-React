  ...
  render() {
    return (
      <div className="container">
        <Form>
          <div className="h4 text-center">Warranty Information</div>
          <p className="text-center p-2">
            Provides warranty description, qualitifications/limits and if
            warranty is transferable between owners..
          </p>
          <FormGroup>
